...
public class BoardConsoleRenderer {
    ...
    private String colourizeSprite(String sprite, Color pieceColor, boolean isSquareDark, boolean isHighlighted){
    ...
    private String getSpriteForEmptySquare(Coordinates coordinates, boolean isHighlight){
        return colourizeSprite("   ", Color.WHITE, Board.isSquareDark(coordinates), isHighlight);
    ...
    private String getPieceSprite(Piece piece, boolean isHighlight) {
        return colourizeSprite(" "+selectUnicodeSpriteForPiece(piece)+" ", piece.color, Board.isSquareDark(piece.coordinates), isHighlight);
